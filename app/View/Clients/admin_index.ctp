<div class="clients index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('hotmail'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($client['Client']['company']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['phone']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['skype']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['google']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['yahoo']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['hotmail']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['modifed']); ?>&nbsp;</td>
